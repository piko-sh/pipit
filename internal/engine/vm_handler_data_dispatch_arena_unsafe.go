...
// ensureSliceAddressableForHeader is a no-op in the unsafe build because ReflectValuePtr
// reads the internal .ptr field directly and is never nil for a valid slice.
//
