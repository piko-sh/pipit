...
TEXT ·handlerSubOpMathSin(SB), NOSPLIT|NOFRAME, $0
	NO_LOCAL_POINTERS
	MOVQ    DX, BX
	SHRQ    $16, BX
	MOVBLZX BL, BX
...
TEXT ·handlerSubOpMathCos(SB), NOSPLIT|NOFRAME, $0
	NO_LOCAL_POINTERS
	MOVQ    DX, BX
	SHRQ    $16, BX
	MOVBLZX BL, BX
...
TEXT ·handlerSubOpMathExp(SB), NOSPLIT|NOFRAME, $0
	NO_LOCAL_POINTERS
	MOVQ    DX, BX
	SHRQ    $16, BX
	MOVBLZX BL, BX
...
TEXT ·handlerSubOpMathTan(SB), NOSPLIT|NOFRAME, $0
	NO_LOCAL_POINTERS
	MOVQ    DX, BX
	SHRQ    $16, BX
	MOVBLZX BL, BX
...
TEXT ·handlerSubOpMathMod(SB), NOSPLIT|NOFRAME, $0
	NO_LOCAL_POINTERS
	MOVQ    DX, BX
	SHRQ    $16, BX
	MOVBLZX BL, BX
